...
export default function (app: Application) {
  ...
  app.get("/driver/profile", userAuthMiddleware, (req, res, next: NextFunction) => {
    return driverController.getDriverProfile(req, res, next);
  });

  // Update driver location
  app.put("/driver/location", userAuthMiddleware, (req, res, next: NextFunction) => {
    return driverController.updateLocation(req, res, next);
  });

  // Update driver status
  app.put("/driver/status", userAuthMiddleware, (req, res, next: NextFunction) => {
    return driverController.updateStatus(req, res, next);
  });

  // Set rally point
  app.put("/driver/rally-point", userAuthMiddleware, (req, res, next: NextFunction) => {
    return driverController.setRallyPoint(req, res, next);
  });

  // Update driver rating
  app.put("/driver/rating", userAuthMiddleware, (req, res, next: NextFunction) => {
